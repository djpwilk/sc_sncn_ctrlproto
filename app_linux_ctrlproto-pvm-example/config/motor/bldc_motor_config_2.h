...
#define MAX_NOMINAL_SPEED_2  			4001	// rpm
#define MAX_NOMINAL_CURRENT_2  			3		// A
#define MAX_ACCELERATION_2   			5001    // rpm/s
#define ENCODER_RESOLUTION_2 			4001	// 4 x Max count of Quadrature Encoder (4X decoding)
...
#define TORQUE_SLOPE_2 					60		// mNm/s * IFM_RESOLUTION
